...
<main id="main" class="main">
	...
	<section class="section dashboard">
		...
		<div class="row">
			<div class="col-md-2">
				<a href="/cnpr-homologation/vehicleType/new" class="btn btn-primary"><i
						...
						<table
							...
							<c:forEach var="vehicle" items="${vehicleList}"
								...
								Actif
									...
									<td><a title="Modifier"
										href="/cnpr-homologation/vehicleType/edit/${vehicle.id}"><i
											class="bi bi-pencil"></i></a> 
										<a
										href="/cnpr-homologation/vehicleType/changeStatus/${vehicle.id}"
