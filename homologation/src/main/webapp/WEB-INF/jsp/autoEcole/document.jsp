...
<main id="main" class="main">
	...
	<section class="section dashboard">
		...
		<div class="row">
			<div class="col-md-4">
				<a href="/cnpr-homologation/autoEcole/view/${autoEcole.id }" class="btn btn-primary"><i
		...
		<div class=row>
			...
			<div class="col-xl-6">
				...
				<div class="card">
					<div class="card-header">Joindre un document</div>
					<div class="card-body">
						<form method="POST" action="/cnpr-homologation/autoEcole/addDocument" enctype="multipart/form-data">
								
								<input type="file" class="form-control input-sm" name="file"
									accept="application/pdf" required /><br /> <input
									type="hidden" class="form-control" required="required"
									name="document_name" value="doc_${autoEcole.codeUnique}" />
