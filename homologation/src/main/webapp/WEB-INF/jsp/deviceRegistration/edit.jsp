		...
		<nav>
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="#">Tableau
						de bord</a></li>
				<li class="breadcrumb-item active">Téléphone / Mettre a jour</li>
			</ol>
		</nav>
	</div>
	<!-- End Page Title -->
											...
											<form:select class="form-select"  path="driver"
												...
												<option value="-1">Selectionner le chauffeur</option>
												 <c:forEach var="driver" items="${driverList}">
													<option value="${driver.id}" ${deviceRegistration.driver.id == driver.id ? 'selected' : ''}>${driver.fullname}</option>
												</c:forEach> 
											</form:select>
