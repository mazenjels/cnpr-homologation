...
<main id="main" class="main">
	...
	<section class="section dashboard">
		...
		<div class="row">
			<div class="col-md-2">
				<a href="/cnpr-homologation/paymentMode/new" class="btn btn-primary"><i
					...
					<form:form>
						<table
							...
							<c:forEach var="paymentMode" items="${paymentModeList}"
								...
								<tr>
									<td>${counter.count}</td>
									<td>${paymentMode.designation}</td>
									<td><c:choose>
											<c:when test="${paymentMode.activeStatus eq false}">Inactif</c:when>
											<c:otherwise>
								Actif
								</c:otherwise>
										</c:choose></td>
									<td><a title="Modifier"
										href="/cnpr-homologation/paymentMode/edit/${paymentMode.id}"><i
											class="bi bi-pencil"></i></a> <a
										href="/cnpr-homologation/paymentMode/delete/${paymentMode.id}"
										title="Supprimer"><i class="bi bi-trash text-danger"></i></a>
										<a
										href="/cnpr-homologation/paymentMode/changeStatus/${paymentMode.id}"
