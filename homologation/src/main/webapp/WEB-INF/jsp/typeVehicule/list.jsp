...
<main id="main" class="main">
		...
		<nav>
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="#">Tableau
						de bord</a></li>
				<li class="breadcrumb-item active">Types de vehicule</li>
			</ol>
		</nav>
	</div>
	<!-- End Page Title -->
	...
	<section class="section dashboard">
		...
		<div class="row">
			<div class="col-md-2">
				<a href="/cnpr-homologation/typeVehicule/new" class="btn btn-primary"><i
				...
				<div class="card-body">
					<form:form>
						<table
							...
							<c:forEach var="vehicle" items="${typeVehiculeList}"
								varStatus="counter">
								<tr>
									<td>${counter.count}</td>
								...
								Actif
									...
									<td><a title="Modifier"
										href="/cnpr-homologation/typeVehicule/edit/${vehicle.id}"><i
											class="bi bi-pencil"></i></a> 
										<a
										href="/cnpr-homologation/typeVehicule/changeStatus/${vehicle.id}"
