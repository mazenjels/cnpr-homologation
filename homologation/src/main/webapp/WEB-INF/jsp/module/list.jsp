...
<main id="main" class="main">
	...
	<section class="section dashboard">
		...
		<div class="row">
			<div class="col-md-2">
				<a href="/cnpr-homologation/module/new" class="btn btn-primary btn-sm"><i
						...
						<table
							...
							<c:forEach var="module" items="${moduleList}"
								...
								<tr>
									...
									<td><c:choose>
											<c:when test="${module.activeStatus eq false}">Inactif</c:when>
											<c:otherwise>
								Actif
								</c:otherwise>
										</c:choose></td>
									<td><a title="Modifier"
										href="/cnpr-homologation/module/edit/${module.id}"><i
											class="bi bi-pencil"></i></a> <a
										href="/cnpr-homologation/module/delete/${module.id}"
										title="Supprimer"><i class="bi bi-trash text-danger"></i></a>
										<a
										href="/cnpr-homologation/module/changeStatus/${module.id}"
